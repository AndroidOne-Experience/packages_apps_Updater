...
import com.androidone.ota.controller.UpdaterController
import com.androidone.ota.controller.UpdaterService
import com.androidone.ota.controller.UpdaterService.LocalBinder
...
import com.androidone.ota.misc.Utils.getCachedUpdateList
import com.androidone.ota.misc.Utils.getChangelogURL
import com.androidone.ota.misc.Utils.getServerURL
import com.androidone.ota.misc.Utils.isABUpdate
import com.androidone.ota.misc.Utils.isUpdateCheckEnabled
import com.androidone.ota.misc.Utils.parseJson
import com.androidone.ota.misc.Utils.securityPatch
import com.androidone.ota.misc.Utils.triggerUpdate
import com.androidone.ota.model.Update
import com.androidone.ota.model.UpdateInfo
...
class UpdatesActivity : AppCompatActivity(), UpdateImporter.Callbacks {
    ...
    private fun applyUpdateStatusStyle(compact: Boolean) {
        ...
        if (compact) {
            ...
            mUpdateStatus.setSingleLine(true)
            mUpdateStatus.maxLines = 1
            mUpdateStatus.ellipsize = TextUtils.TruncateAt.END
