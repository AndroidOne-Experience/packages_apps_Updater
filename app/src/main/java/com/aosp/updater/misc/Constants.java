...
public final class Constants {
    ...
    public static final String PROP_DEVICE = "ro.aosp.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.aosp.build_type";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "aosp.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "aosp.updater.uri";
    public static final String PROP_UPDATER_ALLOW_MAJOR_UPDATE = "aosp.updater.allow_major_update";
