 ...
 */
package net.aosp.ota.controller;
...
import net.aosp.ota.R;
import net.aosp.ota.UpdaterReceiver;
import net.aosp.ota.UpdatesActivity;
import net.aosp.ota.misc.StringGenerator;
import net.aosp.ota.misc.Utils;
