...
if [ ! -f "$1" ]; then
   ...
   echo
   echo "The name of ZIP is assumed to have AndroidOne Experience-VERSION-DATE-TYPE-* as format"
...
# Assume AndroidOne Experience-VERSION-DATE-TYPE-*.zip
...
adb shell "killall com.aosp.updater 2>/dev/null"
adb shell "sqlite3 /data/data/com.aosp.updater/databases/updates.db" \
